...
tmp_process_import AS (
    SELECT jsonb_agg(to_jsonb(tpi)) AS tmp_process_import_rows
      FROM gn_monitoring.tmp_process_import tpi
)
SELECT
    o.id_observation,
    o.uuid_observation,
    ...
    tpi.tmp_process_import_rows AS tmp_process_import_data
...
CROSS JOIN tmp_process_import tpi;
