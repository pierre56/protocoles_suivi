...
SELECT
		...
		(oc.data ->> 'id_nomenclature_sexe'::text)::integer AS id_nomenclature_sex, -- SEXE
 		...
 		(oc.data ->> 'id_nomenclature_observation_status'::text)::integer AS id_nomenclature_observation_status, 
		-- id_nomenclature_blurring, -- DEE_FLOU
        (oc.data ->> 'id_nomenclature_comportement'::text)::integer AS id_nomenclature_behaviour, -- OCC_COMPORTEMENT
